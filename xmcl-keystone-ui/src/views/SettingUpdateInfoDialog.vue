<template>
  ...
  >
    ...
    <v-card
      ...
      style="width: 100%"
      to="https://github.com/Minenetpro/launcher/releases"
      target="browser"
      push
    >
...
const openOfficialWebsite = () => {
  window.open('https://minenet.pro', 'browser')
}
const openGithub = () => {
  window.open('https://github.com/Minenetpro/launcher/releases', 'browser')
}
</script>
